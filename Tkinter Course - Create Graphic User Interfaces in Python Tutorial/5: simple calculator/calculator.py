...
button_add = Button(root, text="add", padx=33, pady=20, command=button_click)
button_sub = Button(root, text="sub", padx=33, pady=20, command=button_click)
button_eqs = Button(root, text="=", padx=100, pady=20, command=button_click)
button_clr = Button(root, text="Clear", padx=96, pady=20, command=button_click)
...
button_eqs.grid(row=6, column=0, columnspan=3)
